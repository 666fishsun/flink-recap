...
public class FlinkApp03TumblingWindowWithProcessTimeProcess {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.fromSource(kafkaSource, WatermarkStrategy.noWatermarks(),
                ...
                .process(
                        new ProcessWindowFunction<Tuple2<String, Long>, Tuple2<String, Long>, String, TimeWindow>() {
                            ...
                            public void process(String s, ProcessWindowFunction<Tuple2<String, Long>, Tuple2<String, Long>, String, TimeWindow>.Context context, Iterable<Tuple2<String, Long>> elements, Collector<Tuple2<String, Long>> out) throws Exception {
                                System.out.println("start time " + context.window().getStart());
                                System.out.println("end time " + context.window().getEnd());
                                System.out.println("process time " + context.currentProcessingTime());
                                Tuple2<String, Long> result = Tuple2.<String, Long>of(s, 0L);
                                for (Tuple2<String, Long> element : elements) {
                                    result.setFields(result.f0, element.f1+result.f1);
                                }
                                out.collect(result);
                            }
                        }
                ...
                .uid("uid-print")
        ;
        env.execute(FlinkApp03TumblingWindowWithProcessTimeProcess.class.getSimpleName());
    }
}
